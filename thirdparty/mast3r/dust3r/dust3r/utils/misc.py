...
def transpose_to_landscape_no(head, decout, true_shape):
    B = len(true_shape)
...
def transpose_to_landscape_yes(head, decout, true_shape):
    B = len(true_shape)
...
def transpose_to_landscape(head, activate=True):
    ...
    return functools.partial(
        transpose_to_landscape_yes if activate else transpose_to_landscape_no, head
    )
